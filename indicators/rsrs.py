...
Originally proposed by Guangda Securities quantitative research. The
right-side standardised variant (slope / std(residuals)) is what we
use here.
...
References:
    https://github.com/hugo2046/QuantsPlaybook (reproduction of the
    original securities-firm research note).
"""
...
class RsrsIndicator(bt.Indicator):
    ...
    For each bar, regress the past N daily highs on the past N daily
    lows:
